...
def train_one_epoch(
    ...
    for x, y, xw, xs in loader:
        ...
        if centers is not None:
            ...
            loss_center_term = centers.center_loss(
                feats_w, y, per_class_weight=per_class_center_w
            )
    ...
    return ce_sum / n_obs, con_sum / n_obs, lambda_supcon
